...
// editorial selection, and writing system prompts. Empty string = fall back to the
// built-in default prompt defined in the corresponding service file.
...
const teamStoryPromptSettingsSchema = new mongoose.Schema({
  ...
  selection_system_prompt: { type: String, default: '' },
